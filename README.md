...
Rdev is inspired by `auto-rsync`, which makes remote development become easier and faster. With rdev, the remote work directory now is auto-syncing with the local directory. Enjoy coding :D
## Installation
